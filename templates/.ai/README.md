...
10. `codegraph/README.md`, `codegraph/graph.json`, and
   `codegraph/hotspots.md` — module map, dependency relationships, risk
...
16. Relevant `skills/*/SKILL.md` — task-specific operating instructions.
...
17. Relevant `openspec/changes/*` — spec-driven change artifacts.
...
- Agents must not edit code outside the task scope without documenting the
  reason.
- In large or unfamiliar projects, agents must use `.ai/codegraph/` to choose
